                ...
                <section class="col-md-12">
                    ...
                    <article class="col-sm-12">
                        ...
                        <section class="col-md-8">
                            ...
                            <ol>
                                <strong><h2>Edite los Textos en la página de <span style="color:red;">EMPRESAS</span></h2> </strong><br/><br/>
                            </ol>

                            <?php
                            $sql = "
                                    SELECT pagina.id_pagina, titulo, pagina.texto 
                                    FROM pagina
                                    WHERE titulo LIKE 'empresa%'
                                    ";
...
//                                . "<td><img width='100%' height='auto' src='../../" . $pagina['ubicacion'] . "'></td>"
                                ...
                                . "<td><input type='button' class='btn btn-info' name='editar' id='editar' onclick='editar2(" . $pagina['id_pagina'] . ");' value=\"Editar\"></td>"
                                . "</tr>";
                            }
                            echo "</table>";
                            ?>
                    ...
                    <article  class="col-sm-12">
                        <section>
                            <ol>
                                <strong>  <h2>Edite las imágenes en la  página de <span style="color:red;">EMPRESAS</span></h2></strong><br/><br/>
                            </ol>
                            <?php
                            ...
                            while ($imagen = mysql_fetch_array($query2)) {
                                ...
                                . "<td><img width='50%' height='auto' src='../../" . $imagen['ubicacion'] . "'></td>"
