                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite Textos en la página de <span style="color:red;">PROYECTOS</span> (Galería)</h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
								from texto
								where titulo like '%galeria%'";
                            ...
                            <form id="form3" name="form3" method="POST" action="controlador/borrarTexto.php">
                                 <input type="hidden" id="BorrarTexto" name="BorrarTexto">
                             </form>
                            -->
                        </section>
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite imágenes de la página de <span style="color:red;">PROYECTOS</span> (Galería)</h2><br/><br/>
                            <?php
                            $sql = "select id_imagen, nombre, ubicacion
								from imagen
								where nombre like '%galeria%'";
                            ...
                            while ($imagen = mysql_fetch_array($query)) {
                                ...
                                //. "<td><input type='button' class='btn btn-success' name='editar' id='editar' onclick='insertar();' value=\"Insertar\">"
                            ...
                            <!--
                            <form id="form4" name="form5" method="POST" action="controlador/BorrarImagen.php">
                                <input type="hidden" id="BorrarImagen" name="BorrarImagen">
                            </form>
                            -->
                        </section>
