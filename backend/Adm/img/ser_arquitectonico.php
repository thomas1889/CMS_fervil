                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los texto de la página de <span style="color:red;">Acustica Arquitectonica.</span></h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
								from texto
								where titulo like '%arquitec%'";
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;">Acustica Arquitectonica.</span></h2><br/><br/>
                            <?php
                            $sql = "select id_imagen, nombre, ubicacion
                            								from imagen
                            								where nombre like '%arquitec%'";
