                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite el  texto de la página de <span style="color:red;">Clientes</span> o para Insertar un Nuevo cliente, pulse<a href="controlador/insertarNuevaImg.php"><button class="btn btn-success"><strong>Aquí</strong></button></a></h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
								from texto
								where titulo like '%clientes%'";
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;"> Clientes</span></h2><br/><br/>
                            <?php
                            ...
                            while ($imagen = mysql_fetch_array($query)) {
                                ...
                                . "<td><img width='200px' height='auto' src='../../Assets/Img/clientes/" . $imagen['ubicacion'] . "'></td>"
                            ...
                            --<form id="form4" name="form4" method="POST" action="controlador/editarCliente.php">
                                <input type="hidden" id="id_imagen" name="id_imagen">
                            </form>

                            <form id="form5" name="form5" method="POST" action="BorrarImagen.php">
                                <input type="hidden" id="Borrarcodigo" name="Borrarcodigo">
                            </form>
                        </section>
