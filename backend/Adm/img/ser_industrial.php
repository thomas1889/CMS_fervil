                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los textos de la página de <span style="color:red;">Acustica Industrial</span></h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
								from texto
								where titulo like '%industrial%'";
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;">Acustica Industrial</span></h2><br/><br/>
                            <?php
                            ...
                            <form id="form3" name="form5" method="POST" action="BorrarImagen.php">
                                <input type="hidden" id="Borrarcodigo" name="Borrarcodigo">
                            </form>
                        </section>
