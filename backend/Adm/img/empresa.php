                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los textos de la página <span style="color:red;">Empresa</span></h2><br/><br/>
                            <?php
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página <span style="color:red;">Empresa</span></h2><br/><br/>
<?php
