                ...
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite los Textos en la página de <span style="color:red;">INICIO</span></h2><br/><br/>
                            <?php
                            $sql = "select id_texto, titulo, tipo, contenido
								from texto
								where titulo like '%inicio%'";
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            ...
                            <h2>Edite las imágenes de la página de <span style="color:red;">INICIO</span></h2><br/><br/>
                            <?php
                            ...
                            <!--
                            <form id="form5" name="form5" method="POST" action="controlador/BorrarImagen.php">
