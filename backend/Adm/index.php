                ...
                <section class="col-md-12">
                    ...
                    <article class="col-sm-12">
                        ...
                        <section class="col-md-8">
                            ...
                            <ol>
                                <strong><h2>Edite los Textos en la página de <span style="color:red;">INICIO</span></h2> </strong><br/><br/>
                            </ol>

                            <?php
                            $sql = "SELECT pagina.id_pagina, titulo, pagina.texto 
                                    FROM pagina
                                    WHERE titulo LIKE 'index%'
                                    ";
...
//                                . "<td><img width='100%' height='auto' src='../../" . $pagina['ubicacion'] . "'></td>"
                        ...
                        <section class="col-md-4" >
                            ...
                            <!--                            
                            <iframe width="1368px" height="720px" scrollbars="no" src="http://fervil.co/" style="
                    ...
                    <article  class="col-sm-12">
                        <section>
                            <ol>
                                <strong>  <h2>Edite las imágenes en la  página de <span style="color:red;">INICIO</span></h2></strong><br/><br/>
                            </ol>
                            <?php
                            $sql2 = "SELECT pagina.*, imagen.*
                                    FROM pagina
