            ...
            <div class="row">
                <section class="posts col-md-12">
                    ...
                    <article class="post clearfix">
                        ...
                        <section>
                            <h2>Inserte un nuevo cliente <span>Imagén</span></h2>

                            <form id="nuevaImg" name="nuevaImg" method="POST" action="insertarImg.php">
                                <table class='table table-hover' style='text-align:justify;'>
                                    ...
                                    <tr>
                                        <td><input type="text" id="codigo" name="codigo" placeholder="" readonly/></td>
                                        <td><input type="text" id="nombre" name="nombre" placeholder="ej:cliente12.png"/></td>
                                        <td><input type="text" id="ubicacion" name="ubicacion" placeholder="cliente12.png"/></td>
                                    </tr>
                                </table>
                            <input type="button" id="envian" name="envian" value="Insertar" onclick="validar();" >
                        </form><br/><br/>
                        </section>
