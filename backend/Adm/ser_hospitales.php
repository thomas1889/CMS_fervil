                ...
                <section class="col-md-12">
                    ...
                    <article class="col-sm-12">
                        ...
                        <section class="col-md-8">
                            ...
                            <ol>
                                <strong><h2>Edite los Textos en la página de <span style="color:red;">HOSPITALES</span></h2> </strong><br/><br/>
                            </ol>

                            <?php
                            $sql = "SELECT pagina.id_pagina, titulo, pagina.texto 
                                    FROM pagina
                                    WHERE titulo LIKE 'hospital%'
                                    ";
...
//                                . "<td><img width='100%' height='auto' src='../../" . $pagina['ubicacion'] . "'></td>"
                    ...
                    <article  class="col-sm-12">
                        <section>
                            <ol>
                                <strong>  <h2>Edite las imágenes en la  página de <span style="color:red;">HOSPITALES</span></h2></strong><br/><br/>
                            </ol>
                            <?php
