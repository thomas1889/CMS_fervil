        ...
        <div id="contenedor">
            ...
            <div id="contenido">
                ...
                <div style="float: left; text-align: justify;width: 55%">
                    <img alt="" src="<?php echo $imagenes[35]['ubicacion']; ?>" width="150px" height="auto"/>
                    ...
                    <p class="Texto8">
                        <?php echo $contenido[28]['texto']; ?><br/>
                        <br/><?php echo $contenido[29]['texto']; ?>
                    </p>
                </div>

                <div style="float: right; text-align: justify;width: 40%; margin-top:150px; margin-bottom: 100px;" >
                    <img src="<?php echo $imagenes[31]['ubicacion']; ?>"  width="80%" height="auto"/>
                </div>
