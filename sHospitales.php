...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="contenedor">
            ...
            <div id="contenido" style="margin-bottom:130px;">

                <div style="float: left; text-align: justify;width: 55%">
                    <img alt="" src="<?php echo $imagenes[37]['ubicacion']; ?>" width="150px" height="auto"/>
                    ...
                    <p class="Texto8">
                        <?php echo $contenido[30]['texto']; ?><br/>
                        <br/> <?php echo $contenido[31]['texto']; ?><br/>

                        <br/> <?php echo $contenido[32]['texto']; ?>
                    </p>
                </div>

                <div style="float: right; text-align: justify;width: 40%; margin-top:200px;" >
                    <img src="<?php echo $imagenes[30]['ubicacion']; ?>"  width="100%" height="auto"/>
                </div>
